    ...
    return (
        <div>
            ...
            <h3>Bienvenue sur mon CV qui est continuellement en chantier vous y trouverez une partie cv classique ainsi que differents liens :
                ...
                aussi si vous pou suivzez les liens tout a droite vous y trouverez une page contact pour me contacter directement par mail  directement bien sur aussi evidemement
            </h3>
        </div>
    );
};
